...
GROQ_MODEL_NAME = os.getenv("GROQ_MODEL_NAME", "gpt-4o")
...
if __name__ == "__main__":
    # sample_query = "SELECT * FROM Product WHERE brand like '%nike%';"
    # result_df = run_query(sample_query)
    # print(result_df)
    question = "show 5 nike shoes in price less then 7k and having discount more than 20 percent"
